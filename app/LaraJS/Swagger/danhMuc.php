 ...
 *              @OA\Schema (
 *                  required={"id"},
 *                  @OA\Property(property="ten_danh_muc", type="VARCHAR", default="NULL", example="Andreane Langosh", description=""),
     *                  @OA\Property(property="mo_ta", type="VARCHAR", default="NULL", example="Mr. Korey Nienow", description=""),
...
class danhMuc
{
    ...
    /**
     * <###> @OA\Property(property="ten_danh_muc", type="VARCHAR", default="NULL", description="")
     */
