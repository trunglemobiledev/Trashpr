 ...
 *              @OA\Schema (
 *                  required={"id"},
 *                  @OA\Property(property="ten_hang", type="VARCHAR", default="NULL", example="Rosalinda Wilkinson", description=""),
     *                  @OA\Property(property="mo_ta", type="VARCHAR", default="NULL", example="Burnice McGlynn", description=""),
 ...
 * )
 * @OA\Get(
 *     path="/thuong-hieus/{id}",
 *     tags={"thuongHieu"},
 *     summary="Edit thuongHieu",
 *     security={{"authApi":{}}},
...
class thuongHieu
{
    ...
    /**
     * <###> @OA\Property(property="ten_hang", type="VARCHAR", default="NULL", description="")
     */
